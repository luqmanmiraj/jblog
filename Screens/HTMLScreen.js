...
//         const htmlItem = jsonData.find(item => item.type === 'html');
//         const docItem = jsonData.find(item => item.type === 'doc');

//         setHtmlContent(htmlItem?.html);
//         setDocUrl(docItem?.docUrl);
//       } catch (error) {
//         console.error('Error fetching or reading content:', error);
//         Alert.alert('Error', 'Failed to fetch or read content');
//       } finally {
//         setIsLoading(false);
//       }
//     };
